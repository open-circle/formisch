...
const TOOL_DEFINITIONS = [
  {
    ...
    description:
      'Searches the Formisch documentation (framework guides, API reference and blog posts) and returns the most relevant pages with links to their Markdown version. Best for finding the right primitive, component, method or core type by name or topic. Set "framework" (angular, preact, qwik, react, react-native, solid, svelte or vue) to scope the search to one framework plus the shared form methods and core types.',
