...
Checks whether a specific field or the entire form is touched by walking through the field store and all its descendants. A field is touched once it has received focus.
