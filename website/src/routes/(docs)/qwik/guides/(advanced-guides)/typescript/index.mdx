...
<Field of={userForm} path={['profile', 'name', 'first']} render$={() => <>{/* ... */}</>} />
<Field of={userForm} path={['profile', 'email']} render$={() => <>{/* ... */}</>} />

// ✗ Invalid paths - TypeScript error
<Field of={userForm} path={['profile', 'age']} render$={() => <>{/* ... */}</>} />
<Field of={userForm} path={['username']} render$={() => <>{/* ... */}</>} />
```
