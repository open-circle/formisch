...
export class ProfileComponent {
  ...
  readonly handleSubmit: SubmitHandler<typeof UserSchema> = async () => {
...
readonly handleSubmit: SubmitHandler<typeof UserSchema> = async (output) => {
...
readonly handleSubmit: SubmitHandler<typeof Schema> = async (output) => {
...
The snippets below assume `this.form` is your form store (the result of <Link href="/angular/api/injectForm/">`injectForm`</Link>).
