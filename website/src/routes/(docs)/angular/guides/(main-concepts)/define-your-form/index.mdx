...
Now that you understand how to define your form schema, continue to the <Link href="/angular/guides/create-your-form/">create your form</Link> guide to learn how to initialize your form with <Link href="/angular/api/injectForm/">`injectForm`</Link>.
