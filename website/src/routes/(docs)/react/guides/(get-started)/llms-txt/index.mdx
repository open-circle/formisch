...
> Please help us by adding more examples of other AI tools. If you use a tool that supports LLMs.txt files, please [open a pull request](https://github.com/open-circle/formisch/pulls) to add it to this page.
