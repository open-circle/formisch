...
description: >-
  Learn how to migrate your forms from Formik to Formisch. This guide maps
  Formik APIs to their Formisch equivalents and walks through the migration
  step by step.
contributors:
  - fabian-hiller
---
...
- **`touched`**: Formisch marks a field as touched when it receives focus or its input is set, while Formik marks it on blur. During ordinary keyboard interaction that means touched-based logic usually reacts on focus instead of waiting for blur.
