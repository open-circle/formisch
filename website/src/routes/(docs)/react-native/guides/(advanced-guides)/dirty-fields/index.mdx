...
export default function EditProfileScreen({ user }: EditProfileProps) {
...
The snippets below assume `form` is your form store (the result of <Link href="/react-native/api/useForm/">`useForm`</Link>).
