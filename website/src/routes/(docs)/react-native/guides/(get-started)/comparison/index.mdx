...
We provide a dedicated migration guide for each library, with a side-by-side example, step-by-step instructions, and an API mapping table: <Link href="/react-native/guides/migrate-from-react-hook-form/">migrate from React Hook Form</Link> and <Link href="/react-native/guides/migrate-from-tanstack-form/">migrate from TanStack Form</Link>. A <Link href="/react-native/guides/migrate-from-formik/">migrate from Formik</Link> guide is also available.

## Next steps

If you have decided that Formisch is a good fit, install it via the <Link href="/react-native/guides/installation/">installation</Link> guide and start building by <Link href="/react-native/guides/define-your-form/">defining your form</Link>.
