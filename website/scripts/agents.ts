...
// URL of the official Formisch agent skill (our single source of truth)
const skillUrl =
  'https://raw.githubusercontent.com/open-circle/agent-skills/main/skills/formisch/SKILL.md';

// Path of the vendored SKILL.md file of our Formisch agent skill
...
// Read SKILL.md file of our Formisch agent skill
      ...
      skills: [
        {
          ...
          type: 'skill-md',
          description,
          url: '/.well-known/agent-skills/formisch/SKILL.md',
  ...
  `${JSON.stringify(
    {
      ...
      description:
        'Search and read the documentation of Formisch, the schema-based, headless and fully type-safe form library for Preact, Qwik, React, Solid, Svelte and Vue.',
