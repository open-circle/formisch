...
describe('getElementInput', () => {
  ...
  describe('text inputs', () => {
    ...
    test('should return value for email input', () => {
      const store = createTestStore(toFormisch(v.object({ email: v.string() })));
    ...
    test('should return value for number input', () => {
      const store = createTestStore(toFormisch(v.object({ age: v.string() })));
  ...
  describe('checkbox inputs', () => {
    test('should return checked state for single checkbox', () => {
      const store = createTestStore(toFormisch(v.object({ agree: v.boolean() })));
  ...
  describe('radio inputs', () => {
    test('should return value when radio is checked', () => {
      const store = createTestStore(toFormisch(v.object({ gender: v.string() })));
  ...
  describe('select inputs', () => {
    test('should return value for single select', () => {
      const store = createTestStore(toFormisch(v.object({ country: v.string() })));
  ...
  describe('file inputs', () => {
    test('should return file for single file input', () => {
      const store = createTestStore(toFormisch(v.object({ document: v.any() })));
  ...
  describe('textarea', () => {
    test('should return value for textarea', () => {
      const store = createTestStore(toFormisch(v.object({ bio: v.string() })));
